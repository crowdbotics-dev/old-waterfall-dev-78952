"""
Django settings for old_waterfall_dev_78952 project.
...
ROOT_URLCONF = 'old_waterfall_dev_78952.urls'
...
WSGI_APPLICATION = 'old_waterfall_dev_78952.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "old_waterfall_dev_78952 API",
    "DESCRIPTION": "API documentation for old_waterfall_dev_78952 App",
    "VERSION": "v1",
}
